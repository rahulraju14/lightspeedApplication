...
-- 'standard' built-in form. This version skips Canadian productions.
-- Note: comments before and after the routine body will not be stored by the server
-- --------------------------------------------------------------------------------
DELIMITER $$

DROP PROCEDURE if exists createStandardUSdocument $$

CREATE PROCEDURE `createStandardUSdocument`(IN form_desc VARCHAR(30), IN form_name VARCHAR(30))
BEGIN
