...
-- 'standard' built-in form. 
-- Note: comments before and after the routine body will not be stored by the server
-- --------------------------------------------------------------------------------
DELIMITER $$

DROP PROCEDURE if exists createAnyStandardDocument $$

CREATE PROCEDURE `createAnyStandardDocument`(IN form_desc VARCHAR(30), IN form_name VARCHAR(30))
BEGIN
