! function() {
    ...
    function m(e) { o(e), x.Version() > 8 && "undefined" == typeof html2canvas && "" == k.screenshot && n(k.assetUrl + "/html2canvas.js?ver=" + w), s(window, "load", function() { a(), u() }), i(k.assetUrl + "/freshwidget.css?ver=" + w) }
